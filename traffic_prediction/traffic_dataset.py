...
# =============================================================================
# （1）读入邻接矩阵
# 首先当然是邻接矩阵的读取，前面的.CSV文件其实就是一个直接能可视化的邻接矩阵，
# 当然不是我们所需的那种，所以才需要处理嘛。
# 如下所示，from和to表示的是节点，cost表示的是两个节点之间的直线距离（来表示权重），
# 在本实验中，权重都为1,
# =============================================================================
...
if __name__ == '__main__':
    train_data = LoadData(data_path=["PeMS/PeMS08.csv", "PeMS/PeMS08.npz"], num_nodes=170, divide_days=[45, 14],
